...
def generate_tweet_lists():
	stanford1_pos = create_data_path(['data', 'stanford_1', 'pos'])
	stanford1_neg = create_data_path(['data', 'stanford_1', 'neg'])
	stanford2 = create_data_path(['data', 'stanford_2', 'training.csv'])
	mich = create_data_path(['data', 'umich', 'training.txt'])
